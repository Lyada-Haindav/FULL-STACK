        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between h-16 items-center">
            <Link href="/" className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-2xl bg-primary text-primary-foreground flex items-center justify-center font-bold">F</div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={item.label} className="rounded-2xl border border-white/10 bg-white/5 p-3 text-xs text-muted-foreground flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={card.title} className="rounded-2xl border border-white/10 bg-white/5 p-6 premium-shadow">
      ...
      <section id="ai" className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 premium-shadow">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={step.title} className="rounded-2xl border border-white/10 bg-white/5 p-6 premium-shadow">
